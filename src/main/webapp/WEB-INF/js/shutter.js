...
(function($, window, document, undefined) {
	...
	Shutter.prototype = {
		...
		initalShutter: function() {
			...
			this.$shutter.css({
				width: this.opts.shutterW,
				height: this.opts.shutterH
			});
		...
		inital: function(elem) {
			...
			this.curDisplay = this.opts.curDisplay > this.shutterItem_len - 1 ? this.opts.curDisplay = this.shutterItem_len -
				1 : this.opts.curDisplay;
			this.b_stop = true;
			this.shutterTitle = '';
			this.playTime = null;
